# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# Nos deux bases de données proviennent de l'INA, elles sont disponibles aux URLs suivantes #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# Probleme dans le format du csv. dans le fichier 'ina-barometre-jt-tv-donnees-mensuelles-2005-2020-nombre-de-sujets.csv' on retire les ';' en trop à la fin des lignes #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

input_file = 'ina-barometre-jt-tv-donnees-mensuelles-2005-2020-nombre-de-sujets.csv'

# Open the file as read
f = open('data_count.csv', "r+")
...
with open(input_file, "w+") as f:
    for i in new_file:
        f.write(i + "\n")
# # # # # # # # # # # # # # # # # # # # # # # # ## # # # # # # # # # # # # # # # # # # # # # # #
# Toutes les données seront utilisées dans les analyses, il n'y a donc pas besoin d'en enlever #
# # # # # # # # # # # # # # # # # # # # # # # # ## # # # # # # # # # # # # # # # # # # # # # # #
